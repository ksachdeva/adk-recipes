...
story_generator = LlmAgent(
    name="StoryGenerator",
    model=LiteLlm(model=os.environ["STORY_GENERATOR_AGENT_MODEL"]),
...
critic = LlmAgent(
    name="Critic",
    model=LiteLlm(model=os.environ["CRITIC_AGENT_MODEL"]),
...
reviser = LlmAgent(
    name="Reviser",
    model=LiteLlm(model=os.environ["REVISER_AGENT_MODEL"]),
...
grammar_check = LlmAgent(
    name="GrammarCheck",
    model=LiteLlm(model=os.environ["GRAMMAR_CHECK_AGENT_MODEL"]),
...
tone_check = LlmAgent(
    name="ToneCheck",
    model=LiteLlm(model=os.environ["TONE_CHECK_AGENT_MODEL"]),
